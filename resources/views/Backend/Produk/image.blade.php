        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active"><a href="{{ route('produk.edit',[$produk->kd_produk]) }}"></a>Edit Product</li>
            ...
            <div class="card card-default">
              ...
              <div class="card-body">
                <div class="nav flex-column">
                  ...
                  <a href="{{ route('produkimage',[$produk->kd_produk]) }}" class="nav-link">Produk Image</a>
                </div>
              </div>
            </div>
          </div>
                ...
                <table table id="example1" class="table table-bordered table-striped">
                   ...
                   <tbody>
                     ...
                     <tr>
                         ...
                         <td>
                           <form class="" action="{{ route('imagedelete',[$image->kd_produk]) }}" method="post" onsubmit="return confirm('Apakah Anda Yakin Akan Menghapus Dara ini ? ')">
                             @csrf
                             {{ method_field('Delete') }}
  ...
  <div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <form action="{{ route('imagestore',[$produk->kd_produk]) }}" method="post" enctype="multipart/form-data" autocomplete="off">
          @csrf
